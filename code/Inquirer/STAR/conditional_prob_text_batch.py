...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_file', type=str, required=True, help="Path to the STAR train file.", default="./STAR_train_ori.json")
    parser.add_argument('--add_file', type=str, required=True, help="Path to the additional STAR file.", default="./STAR_train_add.json")
    parser.add_argument('--batch_size', type=int, default=8, help="Batch size for processing.")
    parser.add_argument('--output_file', type=str, default="./STAR_train_add_prob.json", help="Output file for results.")
    ...
    for i, item in enumerate(train_data):
        ...
        text_out_1 = additional_data[q1_numb]["question"]
        text_out_2 = additional_data[q1_numb + 1]["question"]
