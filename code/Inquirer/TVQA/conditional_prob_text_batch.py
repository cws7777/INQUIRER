...
if __name__ == "__main__":
    ...
    parser.add_argument('--add_file', type=str, required=True, help="Path to the additional TVQA file.", default="./tvqa_train_onlyadd.jsonl")
    parser.add_argument('--batch_size', type=int, default=8, help="Batch size for processing.")
    parser.add_argument('--output_file', type=str, default="./tvqa_train_add_prob.jsonl", help="Output file for results.")
    parser.add_argument('--prompt_path', type=str, default="./tvqa_qa_gen_trial.txt")
    ...
    for i, item in enumerate(train_data):
        ...
        subtitles = srt.read()
        prompt = prompt_format.format(items=items, subtitles=subtitles, question=question, answer=answer, captions=captions, vid_name=vid_name, 
                    knowledge_graphs=knowledge_graphs, ts=ts, show_name=show_name)
        text_in = prompt

        #text_in = f"Question: {item['question']}, Answer: {item['answer']}"
        text_out_1 = additional_data[q1_numb]["q"]
