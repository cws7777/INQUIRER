...
if __name__ == "__main__":
    ...
    parser.add_argument('--add_file', type=str, required=True, help="Path to the additional DramaQA file.", default="./temp_data/AnotherMissOhQA_train_set_onlyadd_scene.json")
    ...
    parser.add_argument('--prompt_path', type=str, default="./sceneaddQA_20240520.txt")
    ...
    for episode in train_data:
        ...
        for scene in scene_level:
            for i, (k, v) in enumerate(scene.items()):
                ...
                prompt = prompt_format.format(scene_description=scene_description, knowledge_graph=scene_kg,
                                                scene_QA=scene_qas)
                text_in = prompt
                count = 0
